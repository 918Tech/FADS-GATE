...
if (-not $env:FADS_COUNTRY) { throw "Set FADS_COUNTRY to the protected asset two-letter country code." }
...
& $EnrollExe --asset-id $AssetId --country $env:FADS_COUNTRY --region $env:FADS_REGION --platform windows --output $TokenFile
